...
function SkillsIndex({ concepts, onOpen }) {
  return (
    <div className="content fadein">
      ...
      <p className="muted">Eight core ideas — each an animated, step-through diagram with a live event log. Click any card.</p>
...
{ when: "May 2026 · now", state: "now", title: "HTTP servers, file servers & PureTube", desc: "Building HTTP servers, file servers & CDNs — and shipping PureTube, my YouTube Shorts topic filter." },
